...
class Pilha {
	...
	public void remover(ArrayList<String> bin) throws Exception {
		if (topo == null) {
			throw new Exception("Erro ao remover!");
		}
		bin.add(topo.elemento.get_title());
		Celula tmp = topo;
		topo = topo.prox;
		tmp.prox = null;
		tmp = null;
...
class Show {
    ...
    */
    ...
    // Ler
    public void ler ( Pilha disneyplus, Inserir insercao ) { 
        try {
            ...
            if ( insercao.modo.compareTo("I") == 0 ) {
    ...
    public static void main ( String args[] ) {
        try {   
            ...
            for ( int y = 0; y < number; y++ ) {
                ...
                s = o.nextLine();
                operator = s.split(" ")[0];
                if ( operator.compareTo("I") == 0 ) {
                    id = s.split(" ")[1];
                    Inserir insercao = new Inserir("I", id, -1);
                    objeto.ler(disneyplus,insercao);
                } else if ( operator.compareTo("R") == 0 ) {
                    disneyplus.remover(bin);
                }
            }
            ...
            int z = disneyplus.n-1;
            for (Celula i = disneyplus.topo; i != null; i = i.prox, z--) {
                System.out.print("["+ z +"] ");
                i.elemento.print();
            }
        }
