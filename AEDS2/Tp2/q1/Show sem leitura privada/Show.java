...
class Show {
    ...
    */
    ...
    public void ler ( String id_target, List disneyplus ) { // adicionar arraylist or whatever como parametro
        try {
            ...
            if ( full_string[index] == "" ) {
                ...
                String title_put = "\"";
                title_put = trimmers(title_put.concat(title_analysis.concat("\"")));
                set_title(title_put);
                int virgula_count = 0;
            ...
            if ( full_string[index] != "" && full_string[index].charAt(0) == '"' ) {
                ...
                index++; //array_director[0] = "NaN"; here
            } else {
                array_director[0] = trimmers(full_string[index++]); //array_director[0] = trimmers(full_string[index++]);
            }
