...
class Alvinegra {
    ...
    public void inserir(Show elemento) throws Exception {
      ...
      if (raiz == null) {
        ...
        // Senao, se a arvore tiver um elemento
            ...
            if (elemento.get_title().compareTo(raiz.elemento.get_title()) < 0) {
        ...
        // Senao, se a arvore tiver dois elementos (raiz e dir)
            ...
            if (elemento.get_title().compareTo(raiz.elemento.get_title()) < 0) {
                raiz.esq = new NoAN(elemento);
            } else if (elemento.get_title().compareTo(raiz.dir.elemento.get_title()) < 0) {
        ...
        // Senao, se a arvore tiver dois elementos (raiz e esq)
            ...
            } else if (elemento.get_title().compareTo(raiz.esq.elemento.get_title()) > 0) {
    ...
    private void balancear(NoAN bisavo, NoAN avo, NoAN pai, NoAN i) {
        ...
        if (pai.cor == true) {
            ...
            if (pai.elemento.get_title().compareTo(avo.elemento.get_title()) > 0) { // rotacao a esquerda ou direita-esquerda
                if (i.elemento.get_title().compareTo(pai.elemento.get_title()) > 0) {
                avo = rotacaoEsq(avo);
                } else {
            ...
            if (bisavo == null) {
                raiz = avo;
            } else if (avo.elemento.get_title().compareTo(bisavo.elemento.get_title()) < 0) {
                bisavo.esq = avo;
            } else {
                bisavo.dir = avo;
            }
    ...
    private void inserir(Show elemento, NoAN bisavo, NoAN avo, NoAN pai, NoAN i) throws Exception {
        if (i == null) {
            if (elemento.get_title().compareTo(pai.elemento.get_title()) < 0) {
            ...
            if (elemento.get_title().compareTo(i.elemento.get_title()) < 0) {
                inserir(elemento, avo, pai, i, i.esq);
            } else if (elemento.get_title().compareTo(i.elemento.get_title()) > 0) {
    ...
    public boolean pesquisar(String comp, Log log) {
        System.out.print("=>raiz");
        return pesquisar(comp, raiz, log);
    }

    private boolean pesquisar(String comp, NoAN i, Log log) {
        boolean resp;
        if (i == null) {
            resp = false;
            log.setComparacoes(log.getComparacoes()+1);
        } else if ( comp.compareTo(i.elemento.get_title()) == 0) {
            resp = true;
            log.setComparacoes(log.getComparacoes()+2);
        } else if (comp.compareTo(i.elemento.get_title()) < 0) {
            System.out.print(" esq");
            resp = pesquisar(comp, i.esq, log);
            log.setComparacoes(log.getComparacoes()+3);
        } else {
            System.out.print(" dir");
            resp = pesquisar(comp, i.dir, log);
            log.setComparacoes(log.getComparacoes()+3);
        }
        return resp;
    }
    ...
    private void caminharCentral(NoAN i) {
        if (i != null) {
            ...
            System.out.print(i.elemento.get_title() + ((i.cor) ? "(p) " : "(b) ")); // Conteudo do no.
...
class Show {
    ...
    */
    ...
    // Ler
    public void ler ( Alvinegra disneyplus, String id_string ) { 
        try {
    ...
    public static void main ( String args[] ) {
        try {
            ...
            double now, time;
            FileWriter logPtr = new FileWriter("matrícula_avinegra.txt");
            Log log = new Log();
            ...
            Alvinegra disneyplus = new Alvinegra();
            ...
            //disneyplus.caminharCentral();

            s = o.nextLine();
            while( s.compareTo("FIM") != 0 ) {
                if ( disneyplus.pesquisar(s, log) ) {
