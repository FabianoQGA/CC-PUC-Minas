...
class Arvore {
    ...
    public No inserir ( Show show, No i ) {
        if ( i == null ) {
            i = new No(show);
        } else if ( i.show.get_title().compareTo(show.get_title()) > 0 ) {
    ...
    public boolean pesquisar ( String title, Log log ) {
        ...
        return pesquisar ( title, raiz, log );
    }
    ...
    public boolean pesquisar ( String title, No i, Log log ) {
        ...
        } else if ( i.show.get_title().compareTo(title) > 0 ) {
    ...
    */
    ...
    public static void main ( String args[] ) {
        try {
            ...
            double now, time;
            FileWriter logPtr = new FileWriter("matrícula_arvoreBinaria.txt");
            Log log = new Log();
